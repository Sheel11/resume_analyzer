...
def analyze_issues(
    ...
    proj_entries = [e for e in parsed_resume.get('projects' , []) if isinstance(e , dict)]
    ...
    has_projects_signal = any(kw in resume_lower for kw in [
        'project' , 'github.com' , 'deployed' , 'bulit a' ,
        'developed a' , 'created a' , 'implemented a' , 'live demo' ,
        'tech stack',
    ])

    if not proj_entries and not has_projects_signal:
        detected.append(
            IssueDetail(
            ...
            explanation=(
                ...
                'ATS systems and recruiters look for concrete projects to validation '
    ...
    # Skills lack supporting evidence 
    ...
    if len(unvalidated) > len(validated):
        ...
        detected.append(IssueDetail(
            ...
            explanation=(
                ...
                f"{len(unvalidated)}) are not backed by any mention in your projects or "

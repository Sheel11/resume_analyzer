...
def identify_matched_keywords(resume_keywords : List[str] , 
                              jd_keywords : List[str]) -> List[str]:
...
def calculate_match_percentage(resume_keywords : List[str] , 
